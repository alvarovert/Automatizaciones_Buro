...
ASUNTO = "TABLERO DETALLE DE AVANCE POR PRODUCTO - DIARIO"
...
Les compartimos el DETALLE DE AVANCE POR PRODUCTO.
"""

# Ruta del archivo adjunto
RUTA_ARCHIVO_ADJUNTO = r"C:\Users\Alvaro Menacho\Documents\INFORZA\TABLEROS\TABLERO DETALLE DE AVANCE POR PRODUCTO.xlsx"  # Reemplaza con la ruta correcta de tu archivo
...
if __name__ == "__main__":
    print("=" * 60)
    print("ENVIANDO CORREO CON TABLERO DE AVANCE POR PRODUCTO INFORZA")
    print("=" * 60)
    enviar_correo()
